function [] = plotLowPassYband(img)
% Author: Murat Kirtay, Robotics Laboratory
% Date: 17/03/2015
% Description: apply low pass filter to UV chanels and extract figure
...
filtered_v = imfilter(img_v, filter);

filtered_rc = img_y + 1.13983 * filtered_v;
filtered_gc = img_y - 0.39465 * filtered_u - 0.58060 * filtered_v;
filtered_bc = img_y + 2.03211 * filtered_u;
...
imshow(img)
title('Filter applied on U and V')
