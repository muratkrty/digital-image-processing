...
filtered_rc = filtered_y + 1.13983 * filtered_v;
filtered_gc = filtered_y - 0.39465 * img_u - 0.58060 * filtered_v;
filtered_bc = filtered_y + 2.03211 * img_u;

img(:, :) = [filtered_rc filtered_gc filtered_bc];

imshow(img)
title('Filter applied on Y and V')
